...
namespace HPlusSport.API.Controllers
{
    ...
    [Route("products")]
    [ApiController]
    public class PorductsV1Controller : ControllerBase
    {
        private readonly ShopContext _context;

        public PorductsV1Controller(ShopContext context)
        {
        ...
        public async Task<IActionResult> GetAllProducts([FromQuery] ProductQueryParameters queryParameters)
        {
            ...
            if (!string.IsNullOrEmpty(queryParameters.SearchTirm))
            {
                products = products.Where(
                    p => p.Name.ToLower()
                             .Contains(queryParameters.Name.ToLower())
    ...
    [Route("products")]
    [ApiController]
    public class PorductsV2Controller : ControllerBase
    {
        private readonly ShopContext _context;

        public PorductsV2Controller(ShopContext context)
        {
